...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <!-- <div class="col-sm-6"> -->
            <h1>Information</h1>
            <a href="/admin/info/form" class="btn btn-success ml-auto"><i class="fa fa-plus"></i> Add user</a>
            <!-- </div> -->
        </div>
    </div><!-- /.container-fluid -->
</section>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr ng-repeat="user in users">
                        ...
                        <td><img src="/assets/upload/{{ user.image }}" class="img-thumbnail" width="120px" alt=""></td>
                        <td>{{ user.title }}</td>
